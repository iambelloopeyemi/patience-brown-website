...
import { Bars, XMark } from "@/app/components/Icons";
      ...
      <HeaderContainer isOpen={isOpen}>
        <NavBarContainer>
          ...
          <Routes
            ...
            liClassName="text-yinmn-blue font-bold uppercase text-[14px] leading-[14px] tracking-widest hover:text-yinmn-blue"
            checkIsActive
          />
